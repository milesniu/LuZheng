...
{
	private BNaviPoint mStartPoint = new BNaviPoint(116.30142, 40.05087, "百度大厦", BNaviPoint.CoordinateType.GCJ02);
	private BNaviPoint mEndPoint = new BNaviPoint(116.39750, 39.90882, "北京天安门", BNaviPoint.CoordinateType.GCJ02);
	...
	private void addViaPoint()
	{
		...
		// 默认坐标系为GCJ
		BNaviPoint viaPoint = new BNaviPoint(longitude / 1e5, latitude / 1e5, "途经点" + (mViaPoints.size() + 1));
		mViaPoints.add(viaPoint);
		Toast.makeText(this, "已添加途经点：" + viaPoint.getName(), Toast.LENGTH_SHORT).show();
	...
	private void launchNavigator()
	{
		...
		BaiduNaviManager.getInstance().launchNavigator(this, 40.05087, 116.30142, "百度大厦", 39.90882, 116.39750, "北京天安门", NE_RoutePlan_Mode.ROUTE_PLAN_MOD_MIN_TIME, // 算路方式
				true, // 真实导航
